...
class helper:
    ...
    def __setup(self):
        ...
        parser.add_argument('-i', '--info', action='store_const', default=False, const=not(False),
                            help="Show the information about what each monkey is doing")
        args = parser.parse_args()
        return args.Other, args.Read, args.info
    ...
    def main(self):
        ...
        other, Read, info = self.__setup()
        return self.__read(other, Read), info
